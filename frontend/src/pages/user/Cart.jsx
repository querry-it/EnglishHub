        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.map((item, i) => (
              <div key={item.id} className="ehub-card p-5 flex items-center gap-4 animate-fade-in-up" style={{ animationDelay: `${i * 0.08}s` }}>
          ...
          {/* Order Summary */}
          <div>
            <div className="ehub-card p-6 sticky top-24 animate-fade-in-up stagger-3">
