  ...
  const ipaCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { symbol: 'ð', word: 'this', ipaWord: '/ðɪs/', audio: 'this' },
      ]
    }
  ];
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          {ipaCategories.map((cat, cIdx) => (
            <div key={cIdx} className="ehub-card p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl">
        ...
        <div className="lg:col-span-4">
          <div className="ehub-card p-6 sticky top-24 space-y-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl">
